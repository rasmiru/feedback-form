...
Welcome to the Feedback Form React JS project! This web application allows you to submit feedback and can be used to collect feedback from customers.

![feedback form app](./images/App.png)
...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/rasmiru/feedback-form.git
   ```
